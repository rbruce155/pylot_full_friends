...
routes['POST']['/add_submit'] = 'Welcome#add_submit'

routes['GET']['/delete/<id>'] = 'Welcome#delete'

routes['GET']['/delete_submit/<int:id>'] = 'Welcome#delete_submit'

routes['GET']['/edit/<int:id>'] = 'Welcome#show_edit'

routes['POST']['/edit_submit/<int:id>'] = 'Welcome#edit_submit'
